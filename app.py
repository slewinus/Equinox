...
post1 = Submission(elliott, "Hello World!", "What am I to become?", dev, "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Robot-icon.svg/1200px-Robot-icon.svg.png")
